# Reporte Oficial de Resultados de la Suite de Pruebas (`pytest`) — SIPTA (v2.6.0)
...
|---|:---:|:---:|
| **Total de Pruebas Ejecutadas** | **190** | ✅ Superada (Meta: $\ge 180$) |
| **Pruebas Aprobadas (Passed)** | **190 (100.0%)** | ✅ Cumple (100% Éxito) |
| **Pruebas Fallidas (Failed)** | **0 (0.0%)** | ✅ Cero Fallos / 0 Regresiones |
| **Pruebas Omitidas (Skipped)** | **0** | ✅ Ejecución Exhaustiva |
| **Tiempo Total de Ejecución** | **57.61 segundos** | ✅ Alta Eficiencia (< 1 min) |
| **Cuadernos Jupyter Validados y Ejecutados** | **25 / 25 (100.0%)** | ✅ 0 Excepciones no controladas |
| **Módulos de Lógica `src/` Testeados** | **17 suites (111 tests)** | ✅ Cobertura Integral $\ge 94\%$ |
...
tests\test_notebooks.py (Discovery, Structure, Syntax, Execution) ....... [ 70%] (79 tests) PASSED
tests\test_pipeline_modeling_viz.py ........                             [ 91%] (8 tests) PASSED
tests\test_statistical_rigor.py ......                                   [ 94%] (6 tests) PASSED
tests\test_validation.py ......                                          [ 97%] (6 tests) PASSED
tests\test_visualization.py .....                                        [100%] (5 tests) PASSED

====================== 190 passed, 65 warnings in 57.61s ======================
```
