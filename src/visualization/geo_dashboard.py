...
DOMAIN_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "08_vulnerabilidad_social": {
        ...
        "nombre": "Vulnerabilidad Social y PUA SDIS",
        "icono": "hand-heart",
        "color_base": "#dc2626",
        "paleta": "Reds",
        "polaridad": "alta_es_privacion",
        "descripcion": "Microdatos de transferencias monetarias IMG, comedores comunitarios, comisarías de familia y vendedores informales (RIVI).",
        "indicador_principal": "tasa_transferencias_img_por_10k_hab",
        "investment_key": "inversion_social_sdis_per_capita_cop",
        "investment_label": "Inversión Social SDIS per Cápita",
        "investment_unit": "COP/hab",
        "indicadores": [
            {
                "col": "tasa_transferencias_img_por_10k_hab",
                "nombre": "Tasa Transferencias Monetarias IMG / 10k hab",
                "unidad": "atenciones/10k",
                "formato": "{:.1f}",
                "desc": "Densidad de atenciones y subsidios del Ingreso Mínimo Garantizado (IMG) por 10.000 habitantes (PUA SDIS 2024).",
                "polaridad": "alta_es_privacion",
            },
            {
                "col": "atenciones_transferencias_img",
                "nombre": "Total Transferencias Monetarias IMG (Volumen Absoluto)",
                "unidad": "atenciones",
                "formato": "{:,.0f}",
                "desc": "Conteo total de transferencias monetarias del Ingreso Mínimo Garantizado asignadas en la localidad.",
                "polaridad": "alta_es_privacion",
            },
            {
                "col": "tasa_atenciones_sdis_por_10k_hab",
                "nombre": "Tasa Atenciones Totales Política Social SDIS / 10k hab",
                "unidad": "atenciones/10k",
                "formato": "{:.1f}",
                "desc": "Cobertura global de servicios y programas de integración social por cada 10.000 habitantes.",
                "polaridad": "alta_es_privacion",
            },
            {
                "col": "atenciones_totales_sdis",
                "nombre": "Total Atenciones de Política Social SDIS",
                "unidad": "atenciones",
                "formato": "{:,.0f}",
                "desc": "Volumen acumulado de servicios sociales integrales prestados por la SDIS en la localidad (PUA 2024).",
                "polaridad": "alta_es_privacion",
            },
            {
                "col": "atenciones_comisarias_familia",
                "nombre": "Atenciones en Comisarías de Familia SDIS",
                "unidad": "atenciones",
                "formato": "{:,.0f}",
                "desc": "Casos y atenciones de protección y convivencia familiar atendidos por la SDIS.",
                "polaridad": "alta_es_privacion",
            },
            {
                "col": "atenciones_habitante_calle_sdis",
                "nombre": "Atenciones a Habitantes de Calle SDIS",
                "unidad": "atenciones",
                "formato": "{:,.0f}",
                "desc": "Servicios asistenciales de autocuidado y acogida a población habitante de y en calle.",
                "polaridad": "alta_es_privacion",
            },
            {
                "col": "rivi_por_10000_hab_2017_2019",
                "nombre": "Vendedores Informales RIVI por 10.000 hab",
                "unidad": "vendedores/10k",
                "formato": "{:.1f}",
                "desc": "Densidad de comercio informal en espacio público caracterizado por el IPES.",
                "polaridad": "alta_es_privacion",
            },
            {
                ...
                "unidad": "comedores",
                "formato": "{:.0f}",
                "desc": "Red de comedores comunitarios de asistencia alimentaria operando en la localidad.",
                "polaridad": "baja_es_privacion",
            },
            {
                "col": "inversion_social_sdis_per_capita_cop",
                ...
                "unidad": "COP/hab",
                "formato": "${:,.0f}",
                "desc": "Presupuesto de asistencia e inversión social de la SDIS ejecutado por habitante.",
                "polaridad": "baja_es_privacion",
            },
        ],
    },
